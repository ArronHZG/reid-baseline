...
python ../tools/continuous_train.py --config_file='../configs/continual_learning.yml' CONTINUATION.T 0.05
python ../tools/continuous_train.py --config_file='../configs/continual_learning1.yml' CONTINUATION.T 0.05
python ../tools/continuous_train.py --config_file='../configs/continual_learning.yml' CONTINUATION.T 0.05 OPTIMIZER.BASE_LR 0.000035
...
python ../tools/continuous_train.py --config_file='../configs/continual_learning.yml' CONTINUATION.T 0.05 LOSS.LOSS_TYPE = 'softmax_arcface_triplet'
python ../tools/continuous_train.py --config_file='../configs/continual_learning.yml' CONTINUATION.T 0.06
